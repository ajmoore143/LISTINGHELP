...
with st.sidebar:
    ...
    if not storage.is_enabled():
        st.caption("Project saving is off (no Supabase secrets configured).")
    else:
        ...
        st.text_input("Project name", key="current_project_name",
                      help="Name this product/family so you can return to it later.")
